  ...
  return (
    <div className="text-xl">
      ...
      <NavLink
        to="/account/wishlist"
        className={({ isActive }) =>
          `flex items-center mt-5   transition-colors duration-300  pl-6 py-4 border rounded-lg transform  hover:bg-[#3BB77E]   hover:text-white ${isActive ? "bg-[#3BB77E]  text-white" : "text-gray-600"
          }`
        }
      >
