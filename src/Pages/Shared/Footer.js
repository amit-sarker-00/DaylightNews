        ...
        <div>
          ...
          <div className="">
            ...
            <div className="flex justify-center md:justify-start gap-3 py-2">
              <a href="https://www.facebook.com/profile.php?id=100073434090411" className="rounded-full transition-all bg-red-600 p-2 hover:bg-white hover:text-red-600 ">
                <IoLogoFacebook className=" sm:text-xl text-lg " />
              </a>
              <a href="https://twitter.com/AbdulQu19463442" className="rounded-full transition-all bg-red-600 p-2 hover:bg-white hover:text-red-600">
                <IoLogoTwitter className="sm:text-xl text-lg " />
              </a>
              <a href="https://mail.google.com/mail/u/0/#inbox" className="rounded-full transition-all bg-red-600 p-2 hover:bg-white hover:text-red-600">
                <IoLogoGoogle className="sm:text-xl text-lg  " />
              </a>
              <a href="https://www.linkedin.com/in/md-abdul-quayum/" className="rounded-full transition-all bg-red-600 p-2 hover:bg-white hover:text-red-600">
                <IoLogoLinkedin className="sm:text-xl text-lg   " />
              </a>
              <a href="https://www.instagram.com/quayumhp/" className="rounded-full transition-all bg-red-600 p-2 hover:bg-white hover:text-red-600">
