...
const ReecntWorkForHomePageSlidebar = ({ data }) =>
{
  ...
  return (
    <Link
      to={`/detail/${ _id }`}
      className="flex items-center hover:text-red-500 justify-evenly lg:justify-start md:text-left transition-all bg-slate-50 mb-1 mx-1 shadow overflow-hidden object-cover hover:ml-5"
    >
      <div className="">
