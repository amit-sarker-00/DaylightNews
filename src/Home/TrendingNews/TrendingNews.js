  ...
  return (
    <div className=" mb-4 sm:mb-10 ">
      <div className="my-3 flex items-center gap-2">
        ...
        <div className="w-2 h-2 mt-1 bg-orange-500 animate-pulse rounded-full"></div>
      </div>
      <div>
        <Splide
          className=" "
        ...
        >
          ...
          {trendingNews?.map((trending) => (
            <SplideSlide key={trending?._id}>
              <div className=" h-80 shadow hover:shadow-2xl border link-hover  ease-in-out duration-300 hover:border-gray-300 ">
